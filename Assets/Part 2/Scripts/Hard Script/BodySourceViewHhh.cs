...
public class BodySourceViewHhh : MonoBehaviour
{
    ...
    public Game_Manager_Hard[] game_Manager;
    ...
    void handMouse()
    {
        ...
        if (Game_Manager_Hard.count >= -1)
        {
            try
            {
                ...
                else if (GameObject.Find("HandRight").transform.position.y <= -3.379 && GameObject.Find("HandRight").transform.position.y >= -4.378 && Game_Manager_Hard.count >= 2 && Game_Manager_Hard.circleChoose && Game_Manager_Hard.triangleChoose)
                {
