...
public class BodySourceViewNnn : MonoBehaviour
{
    ...
    public Game_Manager_Normal[] game_Manager;
    ...
    void handMouse()
    {
        ...
        if (Game_Manager_Normal.count >= -1)
        {
            try
            {
                ...
                else if (GameObject.Find("HandRight").transform.position.y <= -3.379 && GameObject.Find("HandRight").transform.position.y >= -4.378 && Game_Manager_Normal.count >= 2 && Game_Manager_Normal.circleChoose && Game_Manager_Normal.squareChoose)
                {
