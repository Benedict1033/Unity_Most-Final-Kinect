...
public class BodySourceViewHh : MonoBehaviour
{
    ...
    void handMouse()
    {
        ...
        try
        {
            ...
            if (GameObject.Find("HandRight").transform.position.x <= 0.5&&Say_Hard.yes==false)
            {
                if (Say_Hard.yes == false) { 
            ...
            if (GameObject.Find("HandRight").transform.position.x >= -0.5 && Say_Hard.yes) {
                if (Say_Hard.yes )
                {
