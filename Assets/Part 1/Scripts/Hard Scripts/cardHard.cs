...
public class cardHard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            CheckResults();
            BodySourceViewHLast.a = false;
            BodySourceViewHLast.b = false;
            BodySourceViewHLast.c = false;
            BodySourceViewHLast.d = false;
            BodySourceViewHLast.e = false;
            BodySourceViewHLast.f = false;
        }
    }
